...
class QuestionnaireUITest(TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Firefox(executable_path="C:/Users/28D/Downloads/geckodriver.exe")
    ...
    def create_qnaire(self, name):
        ...
        sleep(0.2) #the left sidebar sometimes takes too much time to show the button, so I sleep for a bit here
        self.driver.find_element(By.XPATH, '//span[text()="Vytvořit dotazník"]').click()
